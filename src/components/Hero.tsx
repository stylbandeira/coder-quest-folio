            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1">
                <div className="inline-block bg-accent/20 border border-accent/50 px-4 py-1 rounded-full mb-4">
                  <span className="text-accent font-semibold text-sm">LEVEL 99 DEVELOPER</span>
                </div>
                ...
                <div className="space-y-2 text-foreground/90">
                  ...
                  <p className="flex items-center gap-2">
                    <span className="text-primary">▸</span>
                    <span>Especialização: [Suas especialidades]</span>
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="text-primary">▸</span>
                    <span>Guild: [Empresa atual ou Freelancer]</span>
                  </p>
                </div>
